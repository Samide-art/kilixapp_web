...
This repository now targets Expo Web without replacing the existing native application architecture or Supabase database. The web build uses Metro + React Native Web and keeps the same screens, services, contexts, Storage, Realtime, RPCs, and Edge Functions.
...
See `docs/WEB_CONVERSION.md` for the exact compatibility changes and validation notes.
