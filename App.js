...
import RootNavigator, { navigationLinking } from './src/navigation/RootNavigator';
            ...
            <CartProvider>
              <FavoritesProvider>
                <View style={[styles.container, { backgroundColor: colors.background }]} onLayout={onLayoutRootView}>
                  ...
                  <NavigationContainer linking={Platform.OS === 'web' ? navigationLinking : undefined}>
                    <RootNavigator />
                  </NavigationContainer>
                </View>
              </FavoritesProvider>
